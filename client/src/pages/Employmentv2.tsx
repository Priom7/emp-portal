  ...
  return (
    <Layout>
      <div className="space-y-8 pb-24">
              ...
              <TabsContent value="records" className="space-y-6">
                ...
                >
                  <HistorySection
                    ...
                    onPreviewContract={(fileName) => setContractPreview(fileName)}
                  />
                </AccordionCard>
        ...
        <Dialog open={!!contractPreview} onOpenChange={() => setContractPreview(null)}>
...
function EmploymentDetails({ profile, user, startDate, managerName }: any) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-sm">
      ...
      <DetailField
        label="Contract Type"
        value={profile.contract_type || profile.hr_employment_type || "Permanent"}
      />
      <DetailField
        label="Manager"
        value={managerName}
        ...
        <Card className="border-primary/30 bg-primary/5">
          <CardContent className="p-4 space-y-2">
            ...
            <p className="text-lg font-bold">
              {current.hr_employment_status || current.employment_status || "Status"}
            </p>
            <p className="text-sm">
              {current.hr_employment_type || current.employment_type || "Contract"}
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-4 space-y-2">
            ...
            <p className="text-lg font-bold">
              ...
              <span className="text-sm text-muted-foreground">
                / {current.latest_payment_frequency || current.hr_payment_frequency || "Year"}
              </span>
            </p>
            <p className="text-sm text-muted-foreground">
              Effective{" "}
            ...
            {current.uniq_file_name && (
              <>
                ...
                <Button
                  ...
                  variant="outline"
                  onClick={() =>
                    console.log("Contract record:", current)
                  }
                >
...
function AnalyticsSection({ salaryChartData, currentHistory, entitlement, history }: any) {
  return (
...
function HolidayRequests({ holidayRequests }: any) {
  if (!holidayRequests.length) {
    return <p className="text-sm text-muted-foreground">No holiday requests.</p>;
  }
